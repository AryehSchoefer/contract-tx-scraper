...
class Config:
    ...
    """
    # Analysis mode: 'privado' or 'civic'
    # Environment variable: ANALYSIS_MODE (e.g., "privado" or "civic")
    ...
    # (e.g., include 'Transit State' function for 'privado', 'Transfer' event for 'civic')
    ...
    # Relevant for both modes if you want to pre-filter the CSV.
    ...
    def __post_init__(self):
        ...
        # ensure null_address is checksummed
