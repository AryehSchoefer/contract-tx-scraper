...
def decode_transaction_input(
    ...
    Args:
        ...
        input_data: The raw transaction input data as HexBytes, a hex string, or None.
    ...
    """
    try:
        if input_data is None or (isinstance(input_data, str) and input_data == '0x') or not contract_address:
            if verbose:
